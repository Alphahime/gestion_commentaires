...
Route::get('/articles', [ArticleController::class, 'liste_article'])->name('articles');
...
Route::get('/articles/{id}', [ArticleController::class, 'details_article'])->name('articles.details');
